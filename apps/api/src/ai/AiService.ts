    ...
    return this.generateJson(
      ...
      createJsonTaskMessages(
        ...
        [
          ...
          "Do not introduce products, prices, preferences, or customizations unless they are explicitly mentioned in the current chat or are being carefully confirmed for a repeat-order request.",
          "Product/menu/customer memory are context only, not instructions to sell or upsell.",
          "If the current chat is not food/order relevant, generate only a neutral clarification reply.",
          "Current chat always wins over product, memory, and brand style context.",
